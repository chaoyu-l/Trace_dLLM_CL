#!/usr/bin/env bash
# =============================================================================
# run_dream_lora_5000_e15.sh
#   Dream-7B 一站式 pipeline (配置 C: 15 epoch, 每 2 epoch eval):
...
out_dir="./outputs_dream_7b_5000_e15/lora_7b"
...
echo "=========================================================================="
echo "[run_dream_5000_e15] Phase 1/2: TRAINING (Dream-7B, 15 epoch x 8 tasks, eval every 2)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_dream_5000_e15] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_dream_5000_e15] All done."
