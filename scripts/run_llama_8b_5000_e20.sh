#!/usr/bin/env bash
# =============================================================================
# run_llama_8b_5000_e20.sh
#   LLaMA-3-8B-Instruct 一站式 pipeline (配置 D: 20 epoch, 每 2 epoch eval):
...
out_dir="./outputs_Llama-8b-LoRA_5000_e20/lora_8b"
...
echo "=========================================================================="
echo "[run_llama_5000_e20] Phase 1/2: TRAINING (LLaMA-3-8B, 20 epoch x 5 tasks, eval every 2)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_llama_5000_e20] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_llama_5000_e20] All done."
