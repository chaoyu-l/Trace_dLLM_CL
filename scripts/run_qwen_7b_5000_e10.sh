#!/usr/bin/env bash
# =============================================================================
# run_qwen_7b_5000_e10.sh
#   Qwen2.5-7B-Instruct 一站式 pipeline (配置 B: 10 epoch, 无 in-training eval):
...
out_dir="./outputs_Qwen-7b-LoRA_5000_e10/lora_7b"
...
echo "=========================================================================="
echo "[run_qwen_5000_e10] Phase 1/2: TRAINING (Qwen2.5-7B, 10 epoch x 8 tasks, no eval)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_qwen_5000_e10] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_qwen_5000_e10] All done. Predictions -> $PRED_OUTPUT"
