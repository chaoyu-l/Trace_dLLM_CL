#!/usr/bin/env bash
# =============================================================================
# run_dream_lora_5000_e10.sh
#   Dream-7B 一站式 pipeline (配置 B: 10 epoch, 无 in-training eval):
#     Phase 1: 训练 (LoRA, 8 任务, 每任务 10 epoch, dynamic canvas group=128)
...
out_dir="./outputs_dream_7b_5000_e10/lora_7b"
...
echo "=========================================================================="
echo "[run_dream_5000_e10] Phase 1/2: TRAINING (Dream-7B, 10 epoch x 8 tasks, no eval)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_dream_5000_e10] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_dream_5000_e10] All done. Predictions -> $PRED_OUTPUT"
