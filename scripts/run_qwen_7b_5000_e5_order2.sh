...
out_dir="./outputs_Qwen-7b-LoRA_5000_e5_order2/lora_7b"
...
# =============================================================================
BASE_OUT_DIR="./outputs_Qwen-7b_5000_base_order2/base_metrics"
if [ -f "$BASE_OUT_DIR/results-0-7-ScienceQA.json" ]; then
  echo "[qwen_5000_e5_order2] Phase 0 SKIP: base baseline already at $BASE_OUT_DIR/"
else
  mkdir -p "$BASE_OUT_DIR"
  echo "=========================================================================="
  echo "[qwen_5000_e5_order2] Phase 0/3: BASE INFERENCE (no LoRA, for FWT baseline)"
  echo "=========================================================================="
...
echo "=========================================================================="
echo "[run_qwen_5000_e5_order2] Phase 1/2: TRAINING (Qwen2.5-7B, 5 epoch x 8 tasks, order2)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_qwen_5000_e5_order2] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_qwen_5000_e5_order2] All done. Predictions -> $PRED_OUTPUT"
