#!/usr/bin/env bash
# =============================================================================
# run_dream_lora_5000_e5_order2.sh
...
out_dir="./outputs_dream_7b_5000_e5_order2/lora_7b"
...
#   ScienceQA 在新顺序里位置 idx=7，所以 sentinel 文件为 results-0-7-ScienceQA.json
# =============================================================================
BASE_OUT_DIR="./outputs_dream_7b_5000_base_order2/base_metrics"
if [ -f "$BASE_OUT_DIR/results-0-7-ScienceQA.json" ]; then
  echo "[dream_5000_e5_order2] Phase 0 SKIP: base baseline already at $BASE_OUT_DIR/"
else
  mkdir -p "$BASE_OUT_DIR"
  echo "=========================================================================="
  echo "[dream_5000_e5_order2] Phase 0/3: BASE INFERENCE (no LoRA, for FWT baseline)"
  echo "=========================================================================="
...
# =============================================================================
echo "=========================================================================="
echo "[run_dream_5000_e5_order2] Phase 1/2: TRAINING (Dream-7B, 5 epoch x 8 tasks, order2)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_dream_5000_e5_order2] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_dream_5000_e5_order2] All done. Predictions -> $PRED_OUTPUT"
