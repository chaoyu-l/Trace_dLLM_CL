...
# =============================================================================
BASE_OUT_DIR="./outputs_Qwen-7b_5000_base/base_metrics"
if [ -f "$BASE_OUT_DIR/results-0-7-20Minuten.json" ]; then
  echo "[qwen_5000_e5] Phase 0 SKIP: base baseline already at $BASE_OUT_DIR/"
else
  mkdir -p "$BASE_OUT_DIR"
  echo "=========================================================================="
  echo "[qwen_5000_e5] Phase 0/3: BASE INFERENCE (no LoRA, for FWT baseline)"
  echo "=========================================================================="
