...
out_dir="./outputs_LLaDA-8b-LoRA_5000_e5/lora_8b"
...
echo ""
echo "=========================================================================="
echo "[run_llada_5000_e5] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_llada_5000_e5] All done. Predictions -> $PRED_OUTPUT"
