#!/usr/bin/env bash
# =============================================================================
# run_llama_8b_5000_e15.sh
#   LLaMA-3-8B-Instruct 一站式 pipeline (配置 C: 15 epoch, 每 2 epoch eval):
#     Phase 1: 训练 (LoRA, 8 任务, 每任务 15 epoch)
...
out_dir="./outputs_Llama-8b-LoRA_5000_e15/lora_8b"
...
echo "=========================================================================="
echo "[run_llama_5000_e15] Phase 1/2: TRAINING (LLaMA-3-8B, 15 epoch x 8 tasks, eval every 2)"
echo "=========================================================================="
...
echo ""
echo "=========================================================================="
echo "[run_llama_5000_e15] Phase 2/2: INFERENCE (test split, all rounds)"
echo "=========================================================================="
...
echo ""
echo "[run_llama_5000_e15] All done."
